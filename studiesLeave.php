...
<head>
    ...
    <title>Admin Panel Page - Studies Leave</title>
</head>
<body>
    
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand">Studies leave</a>
...
<div class="searchUser">
    <div class="container-fluid">
        <form class="d-flex" action="studiesLeave.php" method="POST">
        ...
        if(isset($_GET['msg'])){
            if($_GET['msg'] == 'success'){
                ...
                Successfully added studies leave to the staff
            </div>";
            }
...
<div class="studiesLeave">

    <form action="include/studiesLeave.inc.php" method="POST" enctype="multipart/form-data">
    <?php
    if (isset($_POST['search'])){
        ...
        <div class="mb-3">
            <label for="total_studies_leave" class="form-label fw-bold">Total leave:</label>
            <input type="text" class="form-control" id="total_studies_leave" name="total_studies_leave" onkeypress="return restrictAlphabets(event)" required>
        </div>
        <div class="mb-3">
            <label for="studies_start_date" class="form-label fw-bold">Start date:</label>
            <input type="date" class="form-control" id="studies_start_date" name="studies_start_date" required>
        </div>
        <div class="mb-3">
            <label for="studies_end_date" class="form-label fw-bold">End date:</label>
            <input type="date" class="form-control" id="studies_end_date" name="studies_end_date" required>
        </div>
