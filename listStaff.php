...
<head>
    ...
    <title>Admin Panel Page - Staff list</title>
    <style>
         table{
    display: block;
    overflow-x: auto;   
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand">Staff list</a>
...
<div class="searchUser">
    <div class="container-fluid">
        <form class="d-flex" action="listStaff.php" method="POST">
...
<div class="table-container">
    ...
    <table class="table table-responsive table-sm ">
        ...
        if(isset($_POST['search'])){
            ...
            $hashID = base64_encode($row['userid']);
            echo '
            <tr>
                <td class="id-td" scope="row">'.$row['idstaff'].'</td>
                <td><a class="link-profile" href="listStaffInfo.php?idstaff='.$hashID.'">'.$row['fullname'].'</a></td>
            ...
            ';
                ...
                <tbody>
                  <tr>
                    <td style="text-align:center;" colspan="3" scope="row">No staff in the system</td>                
                  </tr>
                </tbody>
                ';
            }
