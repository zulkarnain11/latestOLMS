...
<head>
    ...
    <title>Admin Panel Page - Compassionate Leave</title>
</head>
<body>

<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand">Compassionate leave</a>
...
<div class="searchUser">
    <div class="container-fluid">
        <form class="d-flex" action="compassionateLeave.php" method="POST">
        ...
        if(isset($_GET['msg'])){
            if($_GET['msg'] == 'success'){
                ...
                Successfully added compassionate leave to the staff
            </div>";
            }
...
<div class="compassionateLeave">

    <form action="include/compassionateLeave.inc.php" method="POST" enctype="multipart/form-data">
    <?php
    if (isset($_POST['search'])){
        ...
        <div class="mb-3">
            <label for="total_cmpassionate_leave" class="form-label fw-bold">Total leave:</label>
            <input type="text" class="form-control" id="total_compassionate_leave" name="total_compassionate_leave" onkeypress="return restrictAlphabets(event)" required>
        </div>
        <div class="mb-3">
            <label for="compassionate_start_date" class="form-label fw-bold">Start date:</label>
            <input type="date" class="form-control" id="compassionate_start_date" name="compassionate_start_date" required>
        </div>
        <div class="mb-3">
            <label for="compassionate_end_date" class="form-label fw-bold">End date:</label>
            <input type="date" class="form-control" id="compassionate_end_date" name="compassionate_end_date" required>
        </div>
