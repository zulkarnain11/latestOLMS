...
<div class="confirm-container">
    <div class="card text-dark mb-3" style="max-width: 18rem;">
      <div class="card-header" style="background-color: #1c910b;color:#ffffff;">Approval confirmation</div>
      <div class="card-body">
        <p class="card-text" style="color: #777777;">click the "Yes" button, if you agree with your choice</p>
            <a href="approveConfirm.inc.php?apply='<?php echo $hashId;?>'" class="btn btn-sm btn-primary" name="submit">Yes</a>
