...
<head>
    ...
    <title>Admin Panel Page - Maternity Leave</title>
</head>
<body>
   
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand">Maternity leave</a>
...
<div class="searchUser">
    <div class="container-fluid">
        <form class="d-flex" action="maternityLeave.php" method="POST">
...
<div class="maternityLeave">
    ...
    <form action="include/maternityLeave.inc.php" method="POST" enctype="multipart/form-data">
    <?php
    if (isset($_POST['search'])){
        ...
        <div class="mb-3">
            <label for="total_maternity_leave" class="form-label fw-bold">Total leave:</label>
            <input type="text" class="form-control" id="total_maternity_leave" name="total_maternity_leave" onkeypress="return restrictAlphabets(event)" required>
        </div>
        <div class="mb-3">
            <label for="maternity_start_date" class="form-label fw-bold">Start date:</label>
            <input type="date" class="form-control" id="maternity_start_date" name="maternity_start_date" required>
        </div>
        <div class="mb-3">
            <label for="maternity_end_date" class="form-label fw-bold">End date:</label>
            <input type="date" class="form-control" id="maternity_end_date" name="maternity_end_date" required>
        </div>
