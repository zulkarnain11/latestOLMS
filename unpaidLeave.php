...
<head>
    ...
    <title>Admin Panel Page - Unpaid Leave</title>
</head>
<body>
  
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand">Unpaid leave</a>
...
<div class="searchUser">
    <div class="container-fluid">
        <form class="d-flex" action="unpaidLeave.php" method="POST">
        ...
        if(isset($_GET['msg'])){
            if($_GET['msg'] == 'success'){
                ...
                Successfully added unpaid leave to the staff
            </div>";
            }
...
<div class="unpaidLeave">

    <form action="include/unpaidLeave.inc.php" method="POST" enctype="multipart/form-data">
    <?php
    if (isset($_POST['search'])){
        ...
        <div class="mb-3">
            <label for="total_unpaid_leave" class="form-label fw-bold">Total leave:</label>
            <input type="text" class="form-control" id="total_unpaid_leave" name="total_unpaid_leave" onkeypress="return restrictAlphabets(event)" required>
        </div>
        <div class="mb-3">
            <label for="unpaid_start_date" class="form-label fw-bold">Start date:</label>
            <input type="date" class="form-control" id="unpaid_start_date" name="unpaid_start_date" required>
        </div>
        <div class="mb-3">
            <label for="unpaid_end_date" class="form-label fw-bold">End date:</label>
            <input type="date" class="form-control" id="unpaid_end_date" name="unpaid_end_date" required>
        </div>
